package lab10.TelephoneDirectory;

import java.util.Vector;
import java.util.Iterator;

/**
 * A class that implements a sorted dictionary by using a vector. The dictionary
 * has distinct search keys.
 * 
...
public class SortedVectorDictionary<K extends Comparable<? super K>, V> implements DictionaryInterface<K, V> {
	...
	public V getValue(K key) {
		V result = null; // result to return
	...
	// Returns the array index where the entry with a given search key is or should
	// be.
