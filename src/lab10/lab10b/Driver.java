...
/** 
   ...
   Note: The class Name overrides hashCode in a way that
         causes collisions for the test performed by testHashTable.
...
public class Driver
{
   public static void main(String[] args) 
    ...
    {   
        // For Load Testing the HashedDictionary, print statistics on number of collisions
        //     We are intentionally taking the load factor Lambda past 0.5
        //      where the hash table would normally resize itself
        //     So to suppress the resizing we will have to set the MaxLoadFactor constant to 1.0
        //       
        ...
        try
        {
            Scanner file = new Scanner(new File("phoneBook1k.txt"));
...
Removing interior item Reiss and last item Nancy:
 ...
 Reiss's number is 555-5432 should be 555-5432
 Nancy's number is 555-7894 should be 555-7894
...
testHashTable():
Create a dictionary whose initial hash table has 11 locations:
