...
public class Lab7 
{
    ...
    {   
        ...
        int [] sourceArray, copyArray;  // arrays for testing insertionSort 
                                        // and selectionSort
    ...
    /**
     * Initialize and scramble an int array, either to a known state or a random state
     * @param randomize a boolean indicating whether scramble should be random or known
    ...
    /**
     * Initialize and scramble an Integer array, either to a known state or a random state
     * @param randomize a boolean indicating whether scramble should be random or known
     *   (using false means all copies of this program will run the same)
     */    
